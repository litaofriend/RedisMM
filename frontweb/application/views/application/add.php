...
<div class="page-header">
  <h4>添加业务>>&nbsp;<a href="<?php echo site_url('application/add') ?>">&nbsp;&nbsp;新增&nbsp;</a>/<a href="<?php echo site_url('application/index') ?>">&nbsp;&nbsp;列表&nbsp;</a>/<a  href="<?php echo site_url('application/trash') ?>">&nbsp;&nbsp;回收站&nbsp;</a></h4>
</div>
<hr/>
...
<input type="hidden" name="submit" value="add"/> 
   ...
   <div class="control-group">
    ...
    <div class="controls">
      <input type="text" id="owner"  name="owner" placeholder=""  value="<?php echo set_value('owner'); ?>" >
